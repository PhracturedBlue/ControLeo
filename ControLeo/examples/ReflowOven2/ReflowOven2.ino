...
struct Hardware {
  ...
  ControLeo_LiquidCrystal LCD;     // Specify LCD interface
  ControLeo_MAX31855 Thermocouple; // Specify MAX31855 thermocouple interface
};
Hardware hardware = { 0, {
    4, // upper heater pin
    5, // lower heater pin
...
{
  hardware.LCD.setBuzzer(onOrOff);
  if (onOrOff == ON) {
